...
export default function QRCodeForm() {
  ...
  const productUrl = `shopify://admin/products/${formState.productId}`.split("/").at(-1);
  // [END select-product]
  ...
  return (
    <>
      ...
      <ui-title-bar title={initialFormState.title || "Create QR code"}>
        <button
          variant="breadcrumb"
          onClick={() => (isDirty ? null : navigate("/app/"))}
        >
          QR Codes
        </button>
        {initialFormState.id && (
              ...
              {formState.productId ? (
                ...
                >
                  <s-stack direction="inline" gap="small" alignItems="center">
                    ...
                    <s-link href={productUrl} target="_blank">{formState.productTitle}</s-link>
                  </s-stack>
                  <s-stack direction="inline" gap="small">
                    ...
                    <s-button
                      ...
                      accessibilityLabel="Remove the product the QR code should be for"
                      icon="x"
                      tone="critical"
                    ></s-button>
                  </s-stack>
